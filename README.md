...
### **Sākumlapa**
![Sākumlapa](Images/Sakumlapa.png)
...
### **Meklēt īpašumu**
![Meklēt īpašumu](Images/Meklet.png)
...
### **Sludinājums**
![Sludinājums](Images/sludinajums.png)
Detalizēta sludinājuma lapa ar galeriju, pilnu īpašuma aprakstu, ērtībām un kontaktpersonas informāciju. Īstermiņa īres gadījumā ir pieejams kalendārs ar aizņemtajām dienām un pieteikuma izveides poga.

---

### **Izveidot Sludinājumu**
![Izveidot Sludinājumu](Images/Izveidot.png)
...
![Kļūsti par īpašnieku](Images/Klusti.png)
...
### **Mani Sludinājumi**
![Mani Sludinājumi](Images/Mani.png)
...
### **Pierakstīšanās**
![Pierakstīšanās](Images/login.png)
...
### **2FA apstiprinājums**
![2FA apstiprinājums](Images/2fa.png)
Papildu drošības solis, kurā lietotājs ievada uz e-pastu nosūtīto 6 ciparu kodu. Tas palīdz aizsargāt kontu, samazinot nesankcionētas piekļuves risku.

---

### **Reģistrēties**
![Reģistrēties](Images/register.png)
...
### **Čats**
![Čats](Images/chat.png)
Iebūvēts saziņas rīks, kas ļauj lietotājiem ātri uzsākt sarunu ar īpašniekiem vai saņemt sistēmas paziņojumus. Sarunas tiek atvērtas no čata ikonas un pieejamas jebkurā lapā.

---

### **Mani pieteikumi**
![Mani pieteikumi](Images/pieteikumi.png)
Lietotāja panelis, kurā var pārskatīt iesniegtos pieteikumus un palīdzības centra ziņojumus. Pieejama pieteikumu rediģēšana/dzēšana, kā arī saņemto atbilžu pārskatīšana.

---

### **Administrācijas Panelis**
![Administrācijas Panelis](Images/admin.png)
Spēcīgs administratīvais panelis vietnes moderatoriem un administratoriem. Tas nodrošina pārskatu un navigāciju uz lietotāju, sludinājumu, palīdzības centra un abonementu pārvaldību.
